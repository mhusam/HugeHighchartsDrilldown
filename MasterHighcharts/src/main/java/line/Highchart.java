...
public class Highchart {
    ...
    public static <K> void addMaster(Highchart highchart, Map<String, HighchartMaster<K>> masterCriteria){
        for(String criterias : masterCriteria.keySet()){
            highchart.addMaster(masterCriteria.get(criterias));
        }
    }
    
    public static void addChilds(Highchart highchart, String nameComma, Map<String, List<HighchartMaster<String>>> childsCriteria){
        for(String criterias : childsCriteria.keySet()){
            highchart.addChilds(nameComma, criterias,     childsCriteria.get(criterias));
        }
    }
}
